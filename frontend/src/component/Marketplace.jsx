...
export default function Marketplace() {
    const imgNames = ["Image Placeholder (8).png", "Explore.png", "explored.png", "page.png", "page1.png", "page2.png", "page3.png", "page4.png", "page5.png"];
        ...
        <>
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider', marginTop: "20px" }}>
                <Tabs value={0} variant="fullWidth">
                    <Tab label="NFTs" icon={<Badge badgeContent={99} color="secondary" />} sx={{textTransform:"capitalize",color:'white'}}  iconPosition="end"/>
                    <Tab label="Collections" icon={<Badge badgeContent={199} color="secondary" />} sx={{textTransform:"capitalize",color:'white'}} iconPosition="end" />
                </Tabs>
            </Box>
            <br></br>
