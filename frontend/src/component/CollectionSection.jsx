...
export default function CollectionSection() {
  ...
  return (
    <Box sx={{ display: "flex", gap: { xs: "40px" }, flexDirection: "column" ,padding:"10px 30px"}}>
      <Heading title="Trending Collection" subtitle="Checkout our trending collection updated weekly" btnname="View all" linkBtn="/marketplace"></Heading>
        ...
        {primaryNames.map((data,index)=>{
          return(
            <Grid key={index} item xs={12} md={4} sm={6} lg={4} sx={{display:"flex",justifyContent:"center",cursor:"pointer"}}>
             ...
             <img src={"/"+data} width="250px" height="250px" onClick={()=>navigate("/nftpage")}></img>
