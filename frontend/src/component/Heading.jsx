...
export default function Heading({title,subtitle,btnname,linkBtn}) {
  ...
  return (
   ...
   {btnname &&  <Button onClick={()=>navigate(linkBtn)}  variant="outlined" sx={{marginRight:{lg:"80px"},borderColor:"#A259FF",color:"#A259FF",height:"20%"}} startIcon={<RocketLaunchIcon></RocketLaunchIcon>}>{btnname}</Button>}
  </Box>
  )
}
